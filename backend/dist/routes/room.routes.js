 ...
 * @access  Private
 */
router.post('/', validators_1.validateRoomCreation, room_controller_1.createRoom);
/**
 * @swagger
 * /api/rooms/{id}:
 *   put:
 ...
 */
router.put('/:id', validators_1.validateRoomUpdate, room_controller_1.updateRoom);
/**
 * @swagger
 * /api/rooms/{id}:
 *   delete:
 ...
 * @access  Private
 */
router.post('/:id/join', room_controller_1.joinRoom);
/**
 * @swagger
 * /api/rooms/{id}/leave:
 *   post:
 ...
 * @access  Private
 */
router.post('/:id/leave', room_controller_1.leaveRoom);
...
router.put('/:roomId/canvas', async (req, res) => {
    ...
    try {
        ...
        req.params.id = room.canvas.id.toString();
        return (0, canvas_controller_1.updateCanvas)(req, res);
    }
    catch (error) {
        res.status(500).json({
            status: 'error',
...
router.post('/:roomId/canvas/state', async (req, res) => {
    ...
    try {
        ...
        // Set the canvas ID in params and call the canvas controller
        req.params.id = room.canvas.id.toString();
        return (0, canvas_controller_1.saveCanvasState)(req, res);
    }
    catch (error) {
        res.status(500).json({
            status: 'error',
...
router.get('/:roomId/canvas/history', async (req, res) => {
    ...
    try {
        ...
        // Set the canvas ID in params and call the canvas controller
        req.params.id = room.canvas.id.toString();
        return (0, canvas_controller_1.getCanvasHistory)(req, res);
    }
    catch (error) {
        res.status(500).json({
            status: 'error',
